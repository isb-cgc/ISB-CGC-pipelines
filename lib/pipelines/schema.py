...
class PipelineSchema(object):
	def __init__(self, name, config, logsPath, imageName, scriptUrl=None, cmd=None, cores=1, mem=1, zone=None, diskSize=None,
		...
		if diskSize is not None:
			...
			self.addDisk(name=name, diskType=diskType, diskSize=diskSize, mountPath=mountPath)
	...
	def addDisk(self, name=None, diskType=None, diskSize=None, mountPath=None, autoDelete=True, readOnly=False):
